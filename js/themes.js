...
export const THEMES = [
    ...
    /* ------------------------------------------------------------------ */
    {
        ...
        icon: '🎀',
        vars: {
            '--bg-primary':       '#1a0520',           // Dark purple-black for contrast
            '--bg-surface':       'rgba(255, 105, 180, 0.15)',
            '--bg-surface-hover': 'rgba(255, 105, 180, 0.25)',
            '--bg-input':         'rgba(255, 105, 180, 0.12)',
            '--border-subtle':    'rgba(255, 105, 180, 0.30)',
            '--border-focus':     '#ff69b4',
            '--text-primary':     '#ffffff',
            '--text-secondary':   'rgba(255, 255, 255, 0.85)',
            '--text-muted':       'rgba(255, 255, 255, 0.60)',
            '--accent':           '#ff1493',           // Bright deep pink
            '--accent-text':      '#ffffff',
            '--danger':           '#ff69b4',
            '--danger-bg':        'rgba(255, 105, 180, 0.18)',
            '--wheel-hub':        '#2d0a1f',           // Dark hub for contrast
            '--wheel-hub-border': 'rgba(255, 105, 180, 0.50)',
            '--wheel-label':      '#ffffff',           // White labels for readability
            '--pointer-color':    '#ffd700',
            '--panel-bg':         'rgba(255, 105, 180, 0.10)',
            '--btn-spin-bg':      '#ff1493',
            '--btn-spin-text':    '#ffffff',
            '--btn-add-bg':       '#ff69b4',
            '--btn-add-text':     '#ffffff',
            '--yt-accent':        '#ff1493',
            '--yt-bg':            'rgba(255, 20, 147, 0.15)',
            '--scrollbar-thumb':  'rgba(255, 105, 180, 0.40)',
            '--highlight-bg':     'rgba(255, 105, 180, 0.20)',
            '--mark-bg':          '#ff1493',
            '--mark-text':        '#ffffff',
            '--power-low':        '#ff69b4',
            '--power-mid':        '#ff1493',
        ...
        wheelColors: [
            '#ff1493', '#ff79c5', '#ff69b4', '#ffb6c1',
            '#ff00ff', '#ffc0cb', '#ff1493', '#ff69b4',
            '#ff00ff', '#ffb6c1', '#ff1493', '#ffc0cb',
            '#ff69b4', '#ffc9fd', '#ff00ff', '#ffb6c1',
            '#ff1493', '#ffc0cb', '#ff69b4', '#ff4141',
            '#ff00ff', '#ffb6c1', '#ff1493', '#ffc0cb',
        ],
        confettiColors: [
            '#ff1493', '#ff69b4', '#ff00ff', '#ffffff',
            '#ffb6c1', '#ffc0cb', '#ff1493', '#ff69b4',
        ],
    },
];
