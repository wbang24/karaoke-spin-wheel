...
export const THEMES = [
    ...
    /* ------------------------------------------------------------------ */
    {
        ...
        vars: {
            '--bg-primary':       '#ff1493',
            '--bg-surface':       'rgba(255, 105, 180, 0.25)',
            '--bg-surface-hover': 'rgba(255, 105, 180, 0.40)',
            '--bg-input':         'rgba(255, 105, 180, 0.25)',
            '--border-subtle':    'rgba(255, 105, 180, 0.50)',
            '--border-focus':     '#ff69b4',
            '--text-primary':     '#ffffff',
            ...
            '--accent-text':      '#ffffff',
            '--danger':           '#ff69b4',
            '--danger-bg':        'rgba(255, 105, 180, 0.30)',
            '--wheel-hub':        '#ff1493',
            '--wheel-hub-border': 'rgba(255, 105, 180, 0.60)',
            '--wheel-label':      '#ff1493',
            '--pointer-color':    '#ffd700',
            '--panel-bg':         'rgba(255, 105, 180, 0.20)',
            '--btn-spin-bg':      '#ff1493',
            '--btn-spin-text':    '#ffffff',
            '--btn-add-bg':       '#ff69b4',
            '--btn-add-text':     '#ffffff',
            '--yt-accent':        '#ff1493',
            '--yt-bg':            'rgba(255, 20, 147, 0.25)',
            '--scrollbar-thumb':  'rgba(255, 105, 180, 0.50)',
            '--highlight-bg':     'rgba(255, 105, 180, 0.35)',
            '--mark-bg':          '#ff1493',
            '--mark-text':        '#ffffff',
            '--power-low':        '#ff69b4',
            '--power-mid':        '#ff1493',
